<template>
  <div>
    <div v-if="this.$mq === 'desktopXL'" class="chart" id="reserveNr">
      <v-card class="card" color="#343F57" height="400">
        ...
        <apexchart v-else type="line" height="400" :options="chartOptions" :series="series" />
      </v-card>
    </div>
    <div v-if="this.$mq === 'desktopL'" class="chart" id="reserveNr">
    ...
    <div v-if="this.$mq === 'laptop'" class="chart" id="reserveNr">
      <v-card class="card" color="#343F57" height="290">
        ...
        <apexchart v-else type="line" height="290" :options="chartOptions" :series="series" />
      </v-card>
    </div>
  </div>
</template>
